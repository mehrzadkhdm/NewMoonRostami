...
namespace MySweph
{
    public static class Constants
    {
        ...
        /// Use Swiss Ephemeris
        /// </summary>
        public const int SEFLG_JPLEPH = 1;
        public const int SEFLG_SWIEPH = 2;
        public const int SEFLG_MOSEPH = 4;
        ...
        public const int SE_BIT_DISC_CENTER = 256; //* to be added to SE_CALC_RISE/SET */
        public const int SE_BIT_DISC_BOTTOM = 8192; //* to be added to SE_CALC_RISE/SET */
        public const int SE_BIT_NO_REFRACTION = 512; // to be added to SE_CALC_RISE/SET, */

        /// <summary>
        /// Equatorial positoons (ra and decl.)
        /// </summary>
        public const int SEFLG_EQUATORIAL = 2048;
        public const int SEFLG_XYZ = 4096;
        /// <summary>
        /// Julian calendar
        /// </summary>
